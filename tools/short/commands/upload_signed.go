...
func prepareUpload(ctx context.Context, filename string, file []byte) (*short.CreateSignedURLResponse, error) {
	...
	return makeClient().CreatedSignedURL(ctx, &short.CreateSignedURLRequest{
