...
func NewAWSProviderFromCfg(awsRegion, bucketName, root string) (StorageProvider, error) {
	...
	aws := NewAWSProvider(awsDriver, bucketName, root)
...
func (a *AWS) Get(ctx context.Context, resource *short.Resource) ([]byte, *time.Time, error) {
...
func (a *AWS) GetSize(ctx context.Context, resource *short.Resource) (int, error) {
