...
func (qw *QueryableWrapper) NewFile(ctx context.Context, id, s3, owner string, name *string, mimetype string) (*short.Resource, error) {
	b := NewQueryBuilder()
...
func (qw *QueryableWrapper) NewPendingFile(ctx context.Context, id, s3, owner string, name *string, mimetype string) (*short.Resource, error) {
	b := NewQueryBuilder()
